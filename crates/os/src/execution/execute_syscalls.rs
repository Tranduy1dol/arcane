use crate::hints::vars::constants::STORED_BLOCK_HASH_BUFFER;
use crate::hints::vars::ids::{CURRENT_BLOCK_NUMBER, REQUEST_BLOCK_NUMBER};
...
pub fn is_block_number_in_block_hash_buffer(
    ...
    let request_block_number =
        get_integer_from_var_name(REQUEST_BLOCK_NUMBER, vm, ids_data, ap_tracking)?;
    let current_block_number =
        get_integer_from_var_name(CURRENT_BLOCK_NUMBER, vm, ids_data, ap_tracking)?;
