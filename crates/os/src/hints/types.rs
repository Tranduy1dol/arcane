...
pub fn get_hash_builtin_fields(
    ...
    Ok(match patricia_tree_mode {
        PatriciaTreeMode::Class => (
            SpongeHashBuiltin::x_offset(),
            SpongeHashBuiltin::y_offset(),
            SpongeHashBuiltin::result_offset(),
        ),
        PatriciaTreeMode::State => (
            HashBuiltin::x_offset(),
            HashBuiltin::y_offset(),
            HashBuiltin::result_offset(),
        ),
    })
}
