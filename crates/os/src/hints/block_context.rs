...
use cairo_vm::hint_processor::builtin_hint_processor::hint_utils::{get_ptr_from_var_name, get_relocatable_from_var_name, insert_value_from_var_name, insert_value_into_ap};
...
pub fn deprecated_fee_token_address(
    ...
    insert_value_into_ap(vm, Felt252::from_bytes_be(&deprecated_fee_token_address.to_bytes_be()))
}
